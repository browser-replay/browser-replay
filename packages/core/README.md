...
**This is a simpler version of the [original README](../../README.md) within this browser-replay subpackage**
...
**browser-replay** (built on [rrweb](https://github.com/rrweb-io/rrweb)) mainly includes two functions:
